...
constraint fk_genre_artist_genre_id
    ...
    insert into app_user (app_user_id, username, password_hash, display_name, disabled) values
		...
		(1, 'jsmith89', '$2a$10$HSEwtr8ef.qjHeyHBKHg6ud/r3vjU0Cy8pcv.3eRFzdUrEJKOAxHC', 'John Smith', 0),
        -- original pw was 'Password2!'
        -- this user has the role of admin and user
		(2, 'janeads54', '$2a$10$wTdN34xbg6pLKG.kUSamNu5jClniC/zxaZpSlaYoBpWj3700ekq8u', 'Jane Admin Smith', 0),
        -- original pw was 'P@ssw3rd'
        -- this user has the role of user
		(3, 'gus445', '$2a$10$Y2GsuViVefCtNy1puv4XhOArHAamTPZByEf2XfUsqdjXNu9VJix8q', 'George User Smith', 0);
