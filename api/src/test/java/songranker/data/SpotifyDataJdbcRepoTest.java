...
class SpotifyDataJdbcRepoTest {
    ...
    void shouldCreateValidPlaylist() {
        ...
        assertEquals("38cfqZXcGK4KPtDrGUNMkI", toTest.getPlaylistUri());
        assertEquals("My first playlist!", toTest.getPlaylistName());
        assertEquals("Here&#x27;s the playlist description", toTest.getDescription());
        assertEquals("https://open.spotify.com/playlist/38cfqZXcGK4KPtDrGUNMkI", toTest.getPlaylistUrl());
        assertEquals("https://i.scdn.co/image/ab67616d0000b27368968350c2550e36d96344ee", toTest.getPlaylistImageLink());
    ...
    void createAlbum() {
        ...
        List<Album> toAdd = repo.createAlbum(testSpotifyData);
    ...
    void createGenre() {
        ...
        List<Genre> toAdd = repo.createGenre(testSpotifyData);
